        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full py-2 px-4 rounded-md shadow-sm text-white bg-orange-500 hover:bg-orange-600 focus:ring-2 focus:ring-orange-500 transition duration-200 ${
